...
-- topelttähtedeta
insert ignore into x_nimekujud4 (id, tunnus, v)
select distinct emi_id, 'perenimi',  SUBSTRING_INDEX(SUBSTRING_INDEX(replace(replace(unrepeat(perenimi),'-',';'),' ',';'), ';', n.n), ';', -1)
from kirjed k 
INNER JOIN
(select 1 n union all select 2 union all select 3 union all select 4 union all 
   select 5 union all select 6 union all select 7 union all select 8 union all 
...
insert ignore into x_nimekujud4 (id, tunnus, v)
select distinct emi_id, 'eesnimi',   SUBSTRING_INDEX(SUBSTRING_INDEX(replace(replace(unrepeat(eesnimi), '-',';'),' ',';'), ';', n.n), ';', -1)
from kirjed k 
INNER JOIN
(select 1 n union all select 2 union all select 3 union all select 4 union all 
   select 5 union all select 6 union all select 7 union all select 8 union all 
...
insert ignore into x_nimekujud4 (id, tunnus, v)
select distinct emi_id, 'isanimi',   SUBSTRING_INDEX(SUBSTRING_INDEX(replace(replace(unrepeat(isanimi), '-',';'),' ',';'), ';', n.n), ';', -1)
from kirjed k 
INNER JOIN
(select 1 n union all select 2 union all select 3 union all select 4 union all 
   select 5 union all select 6 union all select 7 union all select 8 union all 
...
insert ignore into x_nimekujud4 (id, tunnus, v)
select distinct emi_id, 'emanimi',   SUBSTRING_INDEX(SUBSTRING_INDEX(replace(replace(unrepeat(emanimi), '-',';'),' ',';'), ';', n.n), ';', -1)
from kirjed k 
INNER JOIN
(select 1 n union all select 2 union all select 3 union all select 4 union all 
   select 5 union all select 6 union all select 7 union all select 8 union all 
